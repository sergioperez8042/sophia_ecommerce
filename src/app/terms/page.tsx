    ...
    <div className="min-h-screen bg-[#FEFCF7] pt-24 pb-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          <Image src="/images/sophia_logo_v2.jpeg" alt="Sophia" width={40} height={40} className="rounded-2xl" />
        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-6 text-gray-600 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>Al acceder y utilizar la plataforma de Sophia, aceptas cumplir con estos Términos de Servicio. Si no estás de acuerdo con alguno de estos términos, te recomendamos no utilizar nuestros servicios.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-2">2. Descripción del Servicio</h2>
            <p>Sophia es una plataforma de comercio electrónico dedicada a la venta de productos de cosmética natural y artesanal. Nuestros servicios incluyen:</p>
          ...
          <section>
            ...
            <p>Todo el contenido de la plataforma, incluyendo textos, imágenes, logos y diseños, es propiedad de Sophia y está protegido por las leyes de propiedad intelectual.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-2">8. Limitación de Responsabilidad</h2>
            <p>Sophia no será responsable de daños indirectos derivados del uso de la plataforma. Nuestros productos son de uso externo y se recomienda realizar una prueba de alergia antes de su uso completo.</p>
          </section>
