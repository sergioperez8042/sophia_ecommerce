            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  ...
                  >
                    <Heart
                      className={`h-5 w-5 stroke-2 transition-colors ${
                        isWishlisted ? 'fill-current text-red-500 group-hover:text-red-400' : 'text-[#4A6741] group-hover:text-white'
                      }`}
                    />
                    {/* Tooltip mejorado */}
              ...
              <div className="flex space-x-0 border-b border-gray-200 bg-gray-50/50">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 py-6 px-6 font-semibold text-lg transition-all duration-300 relative ${
                      activeTab === tab.id
