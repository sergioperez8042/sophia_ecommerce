...
const DEFAULT_TEMPLATES: NewsletterTemplate[] = [
  ...
  <div style="text-align: center; margin-bottom: 30px; border-bottom: 1px solid #C4AC91; padding-bottom: 20px;">
    <h1 style="color: #C4AC91; font-size: 28px; margin: 0;">Sophia</h1>
    <p style="color: #C4AC91; font-size: 13px; margin: 5px 0 0; letter-spacing: 2px;">COSMETICA BOTANICA</p>
  </div>
  <h2 style="color: #C4AC91; font-size: 22px; text-align: center;">Bienvenida a nuestra comunidad</h2>
  ...
  <div style="background: #213529; border: 1px solid #C4AC91; border-radius: 12px; padding: 25px; text-align: center; margin: 30px 0;">
    <p style="margin: 0 0 8px; color: #C4AC91; font-size: 14px;">Tu codigo de descuento de bienvenida:</p>
    <p style="margin: 0; font-size: 32px; font-weight: bold; color: #C4AC91; letter-spacing: 4px;">BIENVENIDA10</p>
    <p style="margin: 10px 0 0; color: #a09880; font-size: 13px;">10% de descuento en tu primer pedido</p>
  </div>
  <div style="text-align: center; margin-top: 30px;">
    <a href="https://sophia-ecommerce.vercel.app" style="display: inline-block; background: #C4AC91; color: #15241B; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 15px;">Explorar productos</a>
  </div>
  ...
  <h2 style="color: #C4AC91; font-size: 22px; text-align: center;">Novedades de temporada</h2>
  <p style="line-height: 1.8; color: #d4cdc0; font-size: 15px;">
  ...
  <div style="background: #213529; border-radius: 12px; padding: 25px; margin: 25px 0;">
    <h3 style="color: #C4AC91; font-size: 18px; margin: 0 0 15px;">Producto destacado</h3>
    ...
    <p style="color: #C4AC91; font-size: 18px; font-weight: bold; margin: 15px 0 0;">$XX.XX</p>
  </div>
  <div style="background: #213529; border-radius: 12px; padding: 25px; margin: 25px 0;">
    <h3 style="color: #C4AC91; font-size: 18px; margin: 0 0 15px;">Tambien te puede interesar</h3>
    <p style="color: #d4cdc0; font-size: 15px; line-height: 1.7; margin: 0;">
  ...
  <div style="text-align: center; margin-top: 30px;">
    <a href="https://sophia-ecommerce.vercel.app" style="display: inline-block; background: #C4AC91; color: #15241B; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 15px;">Ver todos los productos</a>
  </div>
  <p style="color: #a09880; font-size: 12px; text-align: center; margin-top: 40px; border-top: 1px solid #333; padding-top: 20px;">
    Sophia
  </p>
  ...
  <div style="text-align: center; margin: 30px 0;">
    <p style="color: #C4AC91; font-size: 14px; letter-spacing: 3px; margin: 0;">OFERTA EXCLUSIVA</p>
    <h2 style="color: #C4AC91; font-size: 36px; margin: 10px 0;">XX% DESCUENTO</h2>
  ...
  <div style="background: #213529; border: 2px solid #C4AC91; border-radius: 12px; padding: 25px; text-align: center; margin: 30px 0;">
    <p style="margin: 0 0 8px; color: #C4AC91; font-size: 14px;">Usa el codigo:</p>
    <p style="margin: 0; font-size: 32px; font-weight: bold; color: #C4AC91; letter-spacing: 4px;">CODIGOXX</p>
    <p style="margin: 10px 0 0; color: #a09880; font-size: 13px;">Valido hasta [fecha]</p>
  </div>
  <div style="text-align: center; margin-top: 30px;">
    <a href="https://sophia-ecommerce.vercel.app" style="display: inline-block; background: #C4AC91; color: #15241B; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 15px;">Comprar ahora</a>
  </div>
  <p style="color: #a09880; font-size: 12px; text-align: center; margin-top: 40px; border-top: 1px solid #333; padding-top: 20px;">
    Sophia
  </p>
  ...
  <h2 style="color: #C4AC91; font-size: 22px; text-align: center;">Consejos de cuidado natural</h2>
  <p style="line-height: 1.8; color: #d4cdc0; font-size: 15px;">
    Tu piel merece lo mejor. Aqui te compartimos algunos consejos para mantenerla radiante con ingredientes naturales.
  </p>
  <div style="background: #213529; border-left: 3px solid #C4AC91; padding: 20px 25px; margin: 25px 0; border-radius: 0 12px 12px 0;">
    <h3 style="color: #C4AC91; font-size: 16px; margin: 0 0 10px;">1. [Titulo del consejo]</h3>
  ...
  <div style="background: #213529; border-left: 3px solid #C4AC91; padding: 20px 25px; margin: 25px 0; border-radius: 0 12px 12px 0;">
    <h3 style="color: #C4AC91; font-size: 16px; margin: 0 0 10px;">2. [Titulo del consejo]</h3>
    <p style="color: #d4cdc0; font-size: 14px; line-height: 1.7; margin: 0;">
      [Descripcion del consejo con detalles practicos sobre como aplicarlo en la rutina diaria]
    </p>
  </div>
  <div style="background: #213529; border-left: 3px solid #C4AC91; padding: 20px 25px; margin: 25px 0; border-radius: 0 12px 12px 0;">
    <h3 style="color: #C4AC91; font-size: 16px; margin: 0 0 10px;">3. [Titulo del consejo]</h3>
    <p style="color: #d4cdc0; font-size: 14px; line-height: 1.7; margin: 0;">
      [Descripcion del consejo con detalles practicos sobre como aplicarlo en la rutina diaria]
    </p>
  </div>
  <div style="text-align: center; margin-top: 30px;">
    <a href="https://sophia-ecommerce.vercel.app" style="display: inline-block; background: #C4AC91; color: #15241B; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 15px;">Descubrir productos</a>
  </div>
  <p style="color: #a09880; font-size: 12px; text-align: center; margin-top: 40px; border-top: 1px solid #333; padding-top: 20px;">
    Sophia
  </p>
  ...
  <h2 style="color: #C4AC91; font-size: 22px; text-align: center;">De vuelta en stock</h2>
  <p style="line-height: 1.8; color: #d4cdc0; font-size: 15px; text-align: center;">
    El producto que tanto esperabas ya esta disponible otra vez. No dejes pasar esta oportunidad, las unidades son limitadas.
  </p>
  <div style="background: #213529; border: 1px solid #C4AC91; border-radius: 12px; padding: 30px; text-align: center; margin: 30px 0;">
    <p style="color: #a09880; font-size: 13px; margin: 0 0 5px;">DISPONIBLE AHORA</p>
    <h3 style="color: #C4AC91; font-size: 22px; margin: 0 0 10px;">[Nombre del producto]</h3>
    ...
    <p style="color: #C4AC91; font-size: 22px; font-weight: bold; margin: 0;">$XX.XX</p>
  </div>
  <div style="text-align: center; margin-top: 30px;">
    <a href="https://sophia-ecommerce.vercel.app" style="display: inline-block; background: #C4AC91; color: #15241B; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 15px;">Comprar antes de que se agote</a>
  </div>
  <p style="color: #a09880; font-size: 12px; text-align: center; margin-top: 40px; border-top: 1px solid #333; padding-top: 20px;">
    Sophia
  </p>
...
const PRESET_COLORS = [
  ...
  '#C4AC91', '#15241B', '#213529', '#d4cdc0', '#a09880',
...
function VisualEditor({ content, onChange, getIdToken, bgColor, onBgColorChange }: { content: string; onChange: (html: string) => void; getIdToken?: () => Promise<string | null>; bgColor?: string; onBgColorChange?: (color: string) => void }) {
  ...
  const btnActive = "bg-[#2E4A3A] text-white dark:bg-[#C4AC91] dark:text-gray-900";
