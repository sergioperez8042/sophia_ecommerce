...
export default function InlineAccountCreator({ gestor, onSuccess }: InlineAccountCreatorProps) {
  ...
  if (!open) {
    return (
      <button
        ...
        className="inline-flex items-center gap-1.5 text-[10px] px-2.5 py-1 rounded-full bg-[#F5F1E8] dark:bg-[#C9A96E]/15 text-[#2E4A3A] dark:text-[#C9A96E] font-medium hover:bg-[#2E4A3A]/15 dark:hover:bg-[#C9A96E]/25 transition-colors"
  ...
  return (
    <div className="border border-[#2E4A3A]/20 dark:border-[#C9A96E]/20 bg-[#F5F1E8]/60 dark:bg-[#C9A96E]/5 rounded-lg p-3 space-y-2 max-w-md">
      <div className="flex items-center justify-between">
        <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#2E4A3A] dark:text-[#C9A96E]">
        ...
        <button
          ...
          disabled={submitting}
          className="p-0.5 rounded text-[#2E4A3A] dark:text-[#C9A96E] hover:bg-[#2E4A3A]/10 dark:hover:bg-[#C9A96E]/15 disabled:opacity-40"
          aria-label="Cancelar"
        >
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={submitting}
          className="w-full pl-8 pr-2.5 py-1.5 text-xs border border-[#2E4A3A]/20 dark:border-[#C9A96E]/20 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-[#2E4A3A]/30 focus:border-[#2E4A3A] disabled:opacity-60"
        />
      </div>
      ...
      <div className="flex gap-1.5">
        <div className="relative flex-1">
          ...
          <input
            ...
            disabled={submitting}
            className="w-full pl-8 pr-7 py-1.5 text-xs border border-[#2E4A3A]/20 dark:border-[#C9A96E]/20 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-[#2E4A3A]/30 focus:border-[#2E4A3A] disabled:opacity-60"
          />
          <button
            type="button"
        ...
        <button
          ...
          disabled={submitting}
          className="text-[11px] px-2.5 rounded-md bg-[#2E4A3A]/10 dark:bg-[#C9A96E]/15 text-[#2E4A3A] dark:text-[#C9A96E] hover:bg-[#2E4A3A]/20 dark:hover:bg-[#C9A96E]/25 disabled:opacity-50 font-medium transition-colors"
        >
          Generar
        </button>
      </div>
